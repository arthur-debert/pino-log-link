 ...
 */
function mapPropToUrl(object, propName, baseURL, moduleMap, appendToProp) {
    return removeTransformAppend(object, propName, (moduleName) => fromModuleToFileURL(moduleName, moduleMap, baseURL), appendToProp);
}
