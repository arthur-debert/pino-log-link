import { addLogLinkToFormatter } from "./pino-log-link/internals/addLogLinkToFormatter";
 ...
 */
function setupLogLink(pinoConfig: any, moduleNameProp: string, moduleMapperFunc: Function, baseURL: string, appendToProp: string = "msg"): any {
    let formatter = pinoConfig.formatters || {};
    formatter = addLogLinkToFormatter(formatter, 'log', moduleNameProp, moduleMapperFunc, baseURL, appendToProp);
